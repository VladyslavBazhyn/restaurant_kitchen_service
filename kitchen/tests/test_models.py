...
class ModelsTest(TestCase):
    ...
    def test_ingredient_fields_correct(self):
        self.assertEqual(self.ingredient_1.name, "test_ingredient_1")
        self.assertEqual(self.ingredient_1.price, 1)
        self.assertEqual(
            self.ingredient_1.description,
            "test_description_test_description_test_description",
        )
        self.assertEqual(self.ingredient_1.bought_date, datetime.date.today())

    def test_dish_type_fields_correct(self):
        self.assertEqual(self.dish_type_1.name, "test_type_1")
        self.assertEqual(
    ...
    def test_cook_fields_correct(self):
        self.assertEqual(self.cook_1.username, "Cook_1")
        self.assertEqual(self.cook_1.first_name, "First_1")
        self.assertEqual(self.cook_1.last_name, "Last_1")
        self.assertEqual(self.cook_1.years_of_experience, 1)

    def test_dish_fields_correct(self):
        self.assertEqual(self.dish_1.name, "test_dish_1")
        self.assertEqual(
            self.dish_1.description,
            "test_description_test_description_test_description",
        )
        self.assertEqual(self.dish_1.price, 1.11)
        self.assertEqual(self.dish_1.dish_type, self.dish_type_1)
        self.assertEqual(
    ...
    def test_dish_type_str_correct(self):
        self.assertEqual(str(self.dish_type_1), f"{self.dish_type_1.name}")
